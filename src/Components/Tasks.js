		...
		<div className = {task.completed === 'Completed' ? 'tasks completed' : 'tasks'}>
			<div className = "task-title">
				...
				<div className = 'task-icons'>
					...
					{!showDescription &&
						<span className="material-icons-outlined" style = {{ "cursor" : "pointer"}} onClick={() => setShowDescription(true)}>expand_more</span>
					}
					{showDescription &&
						<span className="material-icons-outlined" style = {{ "cursor" : "pointer"}} onClick={() => setShowDescription(false)}>expand_less</span>
					}
				</div>
			</div>
			{showDescription &&
